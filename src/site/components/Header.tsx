      ...
      <div className="container-x">
        <div className="flex h-16 items-center justify-between md:h-20">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <a
              href="tel:920000000"
              className="flex items-center gap-2 text-sm font-semibold text-dark-700 transition-colors hover:text-primary-600"
            >
          ...
          <button
            ...
            className="rounded-lg p-2 text-dark-700 lg:hidden"
          >
      ...
      {isOpen && (
        <div className="animate-slide-down border-t border-dark-100 bg-white lg:hidden">
          <nav className="container-x flex flex-col gap-1 py-4">
            ...
            <Link
              to="/products"
              className="rounded-lg px-4 py-3 text-sm font-semibold text-dark-700 hover:bg-dark-50"
            >
              منتجاتنا
            </Link>
            <div className="mt-2 flex flex-col gap-2 border-t border-dark-100 pt-4">
              ...
              <Link to="/reg" className="btn-primary !py-2 !text-sm">
                اشتر الآن
              </Link>
            </div>
          </nav>
