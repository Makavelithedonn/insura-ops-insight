...
const footerLinks = {
  ...
  company: [
    ...
    { label: 'وظائف', path: '/about' },
    { label: 'الأسئلة الشائعة', path: '/faq' },
  ],
  legal: [
    { label: 'الشروط والأحكام', path: '/terms' },
    { label: 'سياسة الخصوصية', path: '/privacy' },
    { label: 'قواعد ولوائح هيئة التأمين', path: '/terms' },
    { label: 'طريقة رفع شكوى لهيئة التأمين', path: '/terms' },
  ],
};
            ...
            <div className="flex gap-3">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-dark-800 text-dark-400 transition-all hover:bg-primary-600 hover:text-white"
                >
