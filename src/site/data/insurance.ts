...
export const carInsuranceOffers: InsuranceOffer[] = [
  ...
  },
  {
    id: '7',
    companyId: 'gulf',
    companyName: 'الخليجية العامة للتأمين',
    logo: '',
    color: '#193e8c',
    type: 'ضد الغير بلس',
    price: 849,
