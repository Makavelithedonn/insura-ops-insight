...
export const carInsuranceOffers: InsuranceOffer[] = [
  // === ضد الغير (20) — prices & ratings synced with tamnbcare.online/compare ===
  ...
  { id: 'tpl-brooj', companyId: 'brog', companyName: 'بروج للتأمين التعاوني', logo: '', color: '#1b6af0', type: 'ضد الغير', price: 390, deductible: 0, features: TPL_FEATURES, rating: 4.0 },
  ...
  { id: 'tpl-rajhi', companyId: 'rajhi', companyName: 'تكافل الراجحي', logo: '', color: '#0d9583', type: 'ضد الغير', price: 400, deductible: 0, features: TPL_FEATURES, rating: 4.7, popular: true, featured: true },
  ...
  { id: 'tpl-gulf', companyId: 'gulf', companyName: 'الخليجية العامة للتأمين', logo: '', color: '#193e8c', type: 'ضد الغير', price: 425, deductible: 0, features: TPL_FEATURES, rating: 4.1 },
  ...
  { id: 'tpl-national', companyId: 'national', companyName: 'الوطنية للتأمين', logo: '', color: '#14b89c', type: 'ضد الغير', price: 430, deductible: 0, features: TPL_FEATURES, rating: 4.2 },
  { id: 'tpl-alrajhi', companyId: 'alrajhi', companyName: 'الراجحي تكافل', logo: '', color: '#0f776c', type: 'ضد الغير', price: 445, deductible: 0, features: TPL_FEATURES, rating: 4.6 },
  { id: 'tpl-mtkmla', companyId: 'mtkmla', companyName: 'متكاملة للتأمين', logo: '', color: '#ea580c', type: 'ضد الغير', price: 445, deductible: 0, features: TPL_FEATURES, rating: 4.9 },
  ...
  { id: 'tpl-midgulf', companyId: 'midgulf', companyName: 'ميدغلف السعودية', logo: '', color: '#ea580c', type: 'ضد الغير', price: 460, deductible: 0, features: TPL_FEATURES, rating: 4.2 },
  { id: 'tpl-tawuniya', companyId: 'tawuniya', companyName: 'التعاونية', logo: '', color: '#1b6af0', type: 'ضد الغير', price: 470, deductible: 0, features: TPL_FEATURES, rating: 4.6 },
  { id: 'tpl-jazira', companyId: 'jazira', companyName: 'الجزيرة التكافل', logo: '', color: '#0f776c', type: 'ضد الغير', price: 470, deductible: 0, features: TPL_FEATURES, rating: 4.3 },
  { id: 'tpl-livva', companyId: 'livva', companyName: 'ليڤا للتأمين', logo: '', color: '#193e8c', type: 'ضد الغير', price: 480, deductible: 0, features: TPL_FEATURES, rating: 4.4 },
  { id: 'tpl-allianz', companyId: 'allianz', companyName: 'اليانز للتأمين', logo: '', color: '#1454dc', type: 'ضد الغير', price: 505, deductible: 0, features: TPL_FEATURES, rating: 4.5 },

  // === شامل (20) — prices & ratings synced with tamnbcare.online/compare ===
  ...
  { id: 'shm-brooj', companyId: 'brog', companyName: 'بروج للتأمين التعاوني', logo: '', color: '#1b6af0', type: 'شامل', price: 1490, deductible: 750, features: SHAMIL_A, rating: 4.0 },
  ...
  { id: 'shm-rajhi', companyId: 'rajhi', companyName: 'تكافل الراجحي', logo: '', color: '#0d9583', type: 'شامل', price: 1590, deductible: 1000, features: SHAMIL_B, rating: 4.7, popular: true, featured: true },
  ...
  { id: 'shm-gulf', companyId: 'gulf', companyName: 'الخليجية العامة للتأمين', logo: '', color: '#193e8c', type: 'شامل', price: 1610, deductible: 500, features: SHAMIL_C, rating: 4.1 },
  { id: 'shm-jazira', companyId: 'jazira', companyName: 'الجزيرة التكافل', logo: '', color: '#0f776c', type: 'شامل', price: 1640, deductible: 750, features: SHAMIL_A, rating: 4.3 },
  ...
  { id: 'shm-alrajhi', companyId: 'alrajhi', companyName: 'الراجحي تكافل', logo: '', color: '#0f776c', type: 'شامل', price: 1715, deductible: 1000, features: SHAMIL_B, rating: 4.6 },
  { id: 'shm-tawuniya', companyId: 'tawuniya', companyName: 'التعاونية', logo: '', color: '#1b6af0', type: 'شامل', price: 1740, deductible: 500, features: SHAMIL_C, rating: 4.6 },
  { id: 'shm-midgulf', companyId: 'midgulf', companyName: 'ميدغلف السعودية', logo: '', color: '#ea580c', type: 'شامل', price: 1760, deductible: 500, features: SHAMIL_C, rating: 4.2 },
  { id: 'shm-national', companyId: 'national', companyName: 'الوطنية للتأمين', logo: '', color: '#14b89c', type: 'شامل', price: 1760, deductible: 750, features: SHAMIL_A, rating: 4.2 },
  { id: 'shm-mtkmla', companyId: 'mtkmla', companyName: 'متكاملة للتأمين', logo: '', color: '#ea580c', type: 'شامل', price: 1800, deductible: 1000, features: SHAMIL_B, rating: 4.9 },
  { id: 'shm-livva', companyId: 'livva', companyName: 'ليڤا للتأمين', logo: '', color: '#193e8c', type: 'شامل', price: 1805, deductible: 750, features: SHAMIL_A, rating: 4.4 },
  { id: 'shm-allianz', companyId: 'allianz', companyName: 'اليانز للتأمين', logo: '', color: '#1454dc', type: 'شامل', price: 1875, deductible: 750, features: SHAMIL_A, rating: 4.5 },
];
